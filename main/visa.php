      ...
      <div class="container mt-5">
        <div class="container-fluid">
          <div class="row text-center justify-content-center mb-5">
            <div class="col-lg-7">
              <h1 class="section-title text-center text-black">Visas</h1>
            </div>
          </div>
          <div class="row">
            <div class="owl-carousel owl-3-slider">
              <?php
              $sql = "SELECT * FROM tblvisasamples";
              $result = mysqli_query($conn, $sql);
              while ($row = $result->fetch_assoc()) :
              ?>
                <div class="item">
                  <a class="media-thumb" href="<?php echo "img/" . $row['visaImg']; ?>" data-fancybox="gallery">
                    <img src="<?php echo "img/" . $row['visaImg']; ?>" alt="Image" class="img-fluid">
                    <!-- <div class="d-flex text-black">
                    <div>
                      <h4><a href="#" style="pointer-events: none; cursor: default;">Airroam</a></h4>
                    </div>
                  </div> -->
                  </a>
                </div>
    ...
    <div class="untree_co-section">
      <div class="container">
        <div class="container-fluid">
          <div class="row text-center justify-content-center mb-5">
            <div class="col-lg-7">
              <h1 class="section-title text-center text-black">Visa Assistance</h1>
            </div>
          </div>
          <div class="row">
            <?php
            $sql = "SELECT * FROM tblvisa";
            $result = mysqli_query($conn, $sql);
            while ($row = $result->fetch_assoc()) :
            ?>
              <div class="col-lg-2 mb-4">
                <div class="team">
                  <img src="<?php echo "img/" . $row['visaImg']; ?>" alt="Image" class="img-fluid mb-4 rounded-20 shadow">
                  <div class="px-3">
                    <h3 class="mb-0 text-bold text-black"><?php echo $row['vName']; ?></h3>
                  </div>
                </div>
              </div>
            <?php endwhile; ?>
  ...
  <div class="untree_co-section" style="background:#5E9BB8;">
    <form class="contact-form" action="send_email.php" method="POST">
      <div class="container" align="center">
        <h2 class="mb-3 text-white text-bold">You can send your enquiry via the form below.</h2>
